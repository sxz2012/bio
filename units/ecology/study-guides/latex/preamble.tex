...
% \sgroot is the path from the document's folder to study-guides/ (../ for <T>/guide.tex and <T>/exam.tex).
...
% \drawfig{name}: a TikZ/pgfplots figure in figures/name.tex, next to the document (<T>/figures/)
\newcommand{\drawfig}[1]{\input{figures/#1}}
