% Study guide for learning target 1A. Build: python3 units/ecology/study-guides/build.py 1A
...
\drawfig{1A-formative-summative}
...
\drawfig{1A-induction-deduction}
